...
export default function TestimonialsSection() {
  ...
  return (
    <section
      className="w-full py-24 transition-colors duration-700 bg-white text-gray-900"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
          {testimonials.map((t, i) => (
            <motion.div
              ...
              className="p-6 rounded-2xl border border-gray-200 bg-gray-50 shadow-sm hover:shadow-md transition-all"
            >
              <p
                className="text-base leading-relaxed italic mb-6 text-gray-700"
              >
                “{t.message}”
              </p>
